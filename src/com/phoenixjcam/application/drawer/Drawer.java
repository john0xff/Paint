...
public class Drawer extends JPanel implements MouseListener, MouseMotionListener
{
	...
	public Drawer(Dimension drawerSize, Shape shape, State state, int strokeWidth, JPanel backgroundPanel, Paint paint)
	{
		setLayout(null);
	...
	public void printCoords(MouseEvent e)
	{
		...
		paint.getStatusBar().getLblCoords().setText(posX + ",  " + posY + " px");
	}
	...
	public void printDrawerSize()
	{
		...
		paint.getStatusBar().getLblDrawerSize().setText(width + ",  " + height + " px");
	}
	...
	public void renderShape(Graphics2D g2D)
	{
		...
		switch (currentShape)
		{
			...
			case ERASER:
				...
				g2D.setStroke(new BasicStroke(1, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
				g2D.fillRect(startPoint.x - (strokeWidth / 2), startPoint.y - (strokeWidth / 2), strokeWidth, strokeWidth);
				break;
			case PAINTBUCKET:
	...
	public void drawOvwal(Graphics2D g2D)
	{
		...
		{
			g2D.drawOval(startPoint.x, startPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) > 0) && ((startPoint.y - endPoint.y < 0)))
		{
			g2D.drawOval(endPoint.x, startPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) > 0) && ((startPoint.y - endPoint.y > 0)))
		{
			g2D.drawOval(endPoint.x, endPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) < 0) && ((startPoint.y - endPoint.y > 0)))
		{
			g2D.drawOval(startPoint.x, endPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}
	}
	...
	public void drawRectangle(Graphics2D g2D)
	{
		if (((startPoint.x - endPoint.x) < 0) && ((startPoint.y - endPoint.y < 0)))
		{
			g2D.drawRect(startPoint.x, startPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) > 0) && ((startPoint.y - endPoint.y < 0)))
		{
			g2D.drawRect(endPoint.x, startPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) > 0) && ((startPoint.y - endPoint.y > 0)))
		{
			g2D.drawRect(endPoint.x, endPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}

		if (((startPoint.x - endPoint.x) < 0) && ((startPoint.y - endPoint.y > 0)))
		{
			g2D.drawRect(startPoint.x, endPoint.y, Math.abs(startPoint.x - endPoint.x), Math.abs(startPoint.y - endPoint.y));
		}
	}
