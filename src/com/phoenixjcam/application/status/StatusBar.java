...
public class StatusBar extends JToolBar
{
	...
	public StatusBar()
	{
		...
		add(new JLabel(new javax.swing.ImageIcon(getClass().getResource("/icon/coordsPosition.png"))));
		add(drawerCoords());
		add(createSeparator());

		add(new JLabel(new javax.swing.ImageIcon(getClass().getResource("/icon/panelSize.png"))));
		add(drawerSize());
	}
