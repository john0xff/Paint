...
public class ToolBar implements ActionListener
{
	...
	private JComboBox<String> cbZoom()
	{
		...
		cbZoom.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[]
		{ "20 %", "50 %", "100 %", "200 %" }));
	...
	private JComboBox<String> cbTools()
	{
		...
		cbTools.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[]
		{ "Brush", "Pencil", "Line", "Rectangle", "Rounded Rectangle", "Oval", "Eraser", "Paint Bucket" }));
	...
	private JComboBox<String> cbStrokeWidth()
	{
		...
		cbStrokeWidth.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[]
		{ "1", "2", "5", "8", "10", "12", "15", "20", "25", "30", "150", "300" }));
	...
	{
		btnNew = new JButton();
		btnNew.setIcon(new ImageIcon(getClass().getResource("/icon/newFile.png")));
	...
	{
		btnOpen = new JButton();
		btnOpen.setIcon(new ImageIcon(getClass().getResource("/icon/openFile.png")));
	...
	private JButton printImage()
	{
		...
		btnPrint.setIcon(new ImageIcon(getClass().getResource("/icon/printer.png")));
	...
	{
		btnCut = new JButton();
		btnCut.setIcon(new ImageIcon(getClass().getResource("/icon/scissors.png")));
	...
	private JButton pasteImage()
	{
		...
		btnPaste.setIcon(new ImageIcon(getClass().getResource("/icon/paste.png")));
	...
	private JButton zoomOut()
	{
		...
		btnZoomOut.setIcon(new ImageIcon(getClass().getResource("/icon/zoomOut.png")));
	...
	private JButton zoomIn()
	{
		...
		btnZoomIn.setIcon(new ImageIcon(getClass().getResource("/icon/zoomIn.png")));
	...
	private JButton rulers()
	{
		...
		btnRuler.setIcon(new ImageIcon(getClass().getResource("/icon/rulers.png")));
	...
	private JButton strokeMinus()
	{
		...
		btnStrokeDecrease.setIcon(new ImageIcon(getClass().getResource("/icon/minus.png")));
	...
	private JButton strokeAdd()
	{
		...
		btnStrokeIncrease.setIcon(new ImageIcon(getClass().getResource("/icon/add.png")));
	...
	private JButton colors()
	{
		...
		btnColor.setIcon(new ImageIcon(getClass().getResource("/color/palete.png")));
	...
	{
		String stringStrokeWidth = (String) ((JComboBox<?>) cbStrokeWidth).getSelectedItem();
